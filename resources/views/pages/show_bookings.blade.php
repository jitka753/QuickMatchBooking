...
<div class="row">
    ...
    <h1 class="text-center">My bookings for {{$eventName}}</h1>
    </div>
...
<form name="myForm" id="myForm" method="POST" action="{{ route('updatemybooking') }}" onsubmit="return validateForm()">
    ...
    $bookingId=-1;
    @endphp
    {{-- <input type="hidden" name="id_event" value="{{$event}}"> --}}
                        ...
                        <tbody>
                            ...
                            <div class="col-sm-3">
                                <tr>
                                    ...
                                    @if((($company->id_company) === ($time_slot->id_company))  || (($idevent) === ($time_slot->id_event)))
